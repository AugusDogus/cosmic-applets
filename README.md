...
| Feature: Drag to reorder window thumbnails | Window thumbnails in the dock popup can be reordered via drag and drop. | [#1344](https://github.com/pop-os/cosmic-applets/issues/1344) |
